package br.com.trabalhoZoo.zoologico.codec;
...
public class ServicoCodec implements CollectibleCodec<Servico> {
    ...
    public void encode(BsonWriter writer, Servico servico, EncoderContext ec) {
        ...
        String dataConcluido = servico.getDataConcluido();
        String horaConcluido = servico.getHoraConcluido(); 
        ...
        doc.put("hora", hora);
        doc.put("dataConcluido", dataConcluido);
        doc.put("horaConcluido", horaConcluido);
    ...
    public Servico decode(BsonReader reader, DecoderContext dc) {
        ...
        servico.setDataConcluido(doc.getString("dataConcluido"));
        servico.setHoraConcluido(doc.getString("horaConcluido"));
